...
[![Deploy to IBM Cloud](https://cloud.ibm.com/devops/setup/deploy/button_x2.png)](https://cloud.ibm.com/devops/setup/deploy?repository=https://github.com/IBM/text-to-speech-code-pattern.git)
...
6. To see the app and services created and configured for this code pattern, use the [IBM Cloud](https://cloud.ibm.com) dashboard. The app is named `text-to-speech-code-pattern` with a unique suffix. The following services are created and easily identified by the `ttscp-` prefix:

   * ttscp-speech-to-text
